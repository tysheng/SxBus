    ...
    private void startMapActivity(final Stations stations) {
        PermissionUtil.requestLocation(getActivity(), new PermissionUtil.Callback() {
            ...
            public void call(boolean b) {
                if (b) {
                    if (mRunningModel.getTotalStations() != null) {
                        MapActivity.startMap(getContext(), Constant.BUS, mRunningModel.getRunningResults(), mRunningModel.getTotalStations(), stations);
                    } else {
