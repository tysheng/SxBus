...
import tysheng.sxbus.base.BaseRecyclerAdapter;
import tysheng.sxbus.base.TyBindingViewHolder;
...
public abstract class BaseDataBindingAdapter<T, Binding extends ViewDataBinding> extends BaseRecyclerAdapter<T, TyBindingViewHolder<Binding>> {
